...
import { Crown, Mail, Phone, MapPin, Globe, MessageCircle, Camera, X } from "lucide-react"
    ...
    <footer className="bg-background border-t border-border pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold font-outfit uppercase tracking-tighter">Monarch</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center space-x-3 text-muted-foreground">
                ...
                <span>hello@monarchwebstudio.co.za</span>
              </li>
              <li className="flex items-center space-x-3 text-muted-foreground">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} Monarch Web Studio. All rights reserved.</p>
