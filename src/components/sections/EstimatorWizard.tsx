...
export function EstimatorWizard({ initialPlan }: { initialPlan?: string | null }) {
  ...
  const generatePDF = () => {
    ...
    doc.text("MONARCH WEB STUDIO", 14, 32)
    ...
    doc.text("© " + new Date().getFullYear() + " MONARCH WEB STUDIO. ALL RIGHTS RESERVED.", pageWidth / 2, pageHeight - 15, { align: "center" })

    doc.save("Monarch_Estimate.pdf")
  }
